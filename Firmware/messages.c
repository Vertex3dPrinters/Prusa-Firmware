...
const char MSG_WIZARD_WELCOME[] PROGMEM_I1 = ISTR("Hi, I am your Vertex printer. Would you like me to guide you through the setup process?"); //// c=20 r=7
const char MSG_WIZARD_WELCOME_SHIPPING[] PROGMEM_I1 = ISTR("Hi, I am your Vertex printer. I will guide you through a short setup process, in which the Z-axis will be calibrated. Then, you will be ready to print."); ////c=20 r=16
...
const char MSG_CHOOSE_NOZZLE[] PROGMEM_I1 = ISTR("Choose nozzle size"); ////c=20
