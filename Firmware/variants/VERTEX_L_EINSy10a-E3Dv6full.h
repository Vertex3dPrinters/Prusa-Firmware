...
// Printer revision
#define PRINTER_TYPE PRINTER_VERTEX_L
#define PRINTER_NAME PRINTER_VERTEX_L_NAME
#define PRINTER_MMU_TYPE PRINTER_VERTEX_L_MMU2
#define PRINTER_MMU_NAME PRINTER_VERTEX_L_MMU2_NAME
...
// Printer name
#define CUSTOM_MENDEL_NAME "VERTEX L"
